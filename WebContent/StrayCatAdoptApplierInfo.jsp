...
.divTableCell, .divTableHead { display: table-cell; height: 50px;}
.divTableHeading { display: table-header-group;}
...
<br>
	...
	<div class="divTableHeading">
		<div class="divTableRow">
			...
			<div class="divTableHead">신청서</div>
		</div>
	</div>
	<div class="divTableBody">
		<div class="divTableRow">
			<div class="divTableCell">
			<span>nare0317 님이 쓴 게시글</span>
		...
		<br><br>
		   ...
		   <a class="btn btn-secondary btn-lg" href="#" role="button" id="completebtn">돌아가기</a>
		</div>
		</div>
		</div>
