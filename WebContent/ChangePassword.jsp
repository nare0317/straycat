				...
				<form action="" onSubmit="return check()">
					...
					<div class="row" style="margin-top: 40px; width: 100%;">
						<div class="col-md-6 offset-md-3">
							...
							<div class="input-group">
								<div class="input-group-prepend">
									<span class="input-group-text bolck" style="width:150px;">새 비밀번호</span>
								</div>
								<input type="text" id="userId" name="userId" class="form-control">
							</div><br>
							<div class="input-group">
								<div class="input-group-prepend">
									<span class="input-group-text bolck" style="width:150px;">새 비밀번호 확인</span>
								</div>
								<input type="text" id="userId" name="userId" class="form-control">
							</div>
							<br>
							<span class="err">비밀번호가 일치하지 않습니다.</span>
							<br> <br> <br>
