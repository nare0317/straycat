...
<body>
	...
	<div class="container">
		...
		<table class="table table-bordered">
			...
			<thead>
				<tr>
					...
					<td>
						<h5>
							ID : ${app.ID } <br>이름 : ${app.NAME } <br>
						</h5> <a href="#"><ion-icon name="send" size={20}></ion-icon></a><span>
							쪽지 보내기</span><br> <a href="#"><ion-icon name="pin" size={20}></ion-icon></a><span>
							${app.ADDRESS }</span>
					</td>
		...
		<div class="matching">
			...
			<!-- 모달 팝업창 여는 버튼  -->
			<button id="myBtn" type="button" class="btn btn-primary btn"
				data-toggle="modal" data-target="#myModal">후보자선택</button>
		</div>
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="jumbotron">
								...
								<p class="lead">
									<br>
									<br> 길냥이의 행복한 묘생을 위해 신중하게<br> 결정해주셔서 감사합니다! 이후 입양 과정은<br>
									nare0317님과 1:1로 연락하여 진행하신 후,<br> 완료된 입양 게시글 상태는 '입양완료'로<br>
									바꿔주시기 바랍니다.<br>
									<br>
									<br>
								</p>
