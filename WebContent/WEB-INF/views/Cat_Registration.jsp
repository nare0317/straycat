...
<!-- JS 파일 -->
<script src="<%=cp%>/js/view/cat_registration.js"></script>
...
<script type="text/javascript">
	$(document).ready(function()
	{
		...
		// 구 정보를 선택하면 동 option을 동적 생성.
		$("#gu").on("change", function()
		{
			$.ajax({
				method: "GET",
				url: "<c:url value='/catgetdong'/>",
				data: {"gu":$("#gu").val()},
			...
			<div class="col-7">
				...
				<div class="form-group row">
					<label for="rsq-date" class="col-sm-2 col-form-label">구조일시</label>
						<div class="col-sm-4">
							<input type="text" class="form-control" id="cat_date" name="cat_date" placeholder="날짜를 선택하세요." required>
						</div>
				</div>
				...
				<!-- 특이사항 -->   
				<div class="form-group row">
					<label for="colFormLabel" class="col-sm-2 col-form-label">고양이<br>특이사항</label>
					<div class="col-sm-10">
						<textarea class="form-control" id="cat_etc1" name="cat_etc1" placeholder="고양이의 특징이나 생김새에 대해 자세히 기술해주세요. 고양이를 찾는데 큰 도움이 됩니다."
