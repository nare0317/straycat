    ...
    function html5Upload() {	
    	...
    	//sUploadURL= '/sp/image/html5Upload'; 	//upload URL	// check~!!!
    	sUploadURL= '/FinalProject/image/html5Upload';
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			//sUrl  : location.href.replace(/\/[^\/]*$/, '') + '/sp/image/generalUpload',	//샘플 URL입니다.	// check~!!!
 			sUrl  : location.href.replace(/\/[^\/]*$/, '') + '/FinalProject/image/generalUpload',
