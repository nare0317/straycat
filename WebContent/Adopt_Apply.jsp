		...
		<div class="row">
			<div class="col-7">
				...
				<div class="form-group row">
					...
					<div class="col-sm-3">
						<select class="custom-select" id="custom-select1" required>
				...
				<div class="form-group row">
					<label for="colFormLabel" class="col-sm-2 col-form-label">고양이<br>양육경험
					</label>
				...
				<div class="form-group row">
					<label for="colFormLabel" class="col-sm-2 col-form-label">가족<br>구성원
						수
					</label>
				...
				<div class="form-group row">
					...
					<div class="col-sm-10" id="yesno">
						...
						<div class="custom-control custom-radio custom-control-inline">
							<input type="radio" id="customRadioInline22"
								name="customRadioInline4" class="custom-control-input" required>
					...
					<div class="col-sm-7">
						<input type="text" class="form-control" id="colFormLabel"
							placeholder="ex)강아지/2살/수컷/중성화했어요" maxlength="20" required>
					</div>
				</div>
				<div class="form-group row">
